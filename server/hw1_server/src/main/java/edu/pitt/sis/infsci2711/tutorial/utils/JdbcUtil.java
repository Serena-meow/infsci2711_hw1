...
public class JdbcUtil {
	...
	public static final String DEFAULT_USER = "2711"; //CHANGE TO YOUR MYSQL USER NAME
	
	public static final String DEFAULT_PASSWOD = "123"; // CHANGE TO YOUR MYSQL PASSWORD
